...
def analyze_content(text):
    ...
    response = openai.Completion.create(
        model="text-davinci-003",  # Or GPT-4, if you're using it
        prompt=prompt,
        max_tokens=500,  # Adjust depending on response length needed
        temperature=0.7  # Control randomness for consistency
    )
